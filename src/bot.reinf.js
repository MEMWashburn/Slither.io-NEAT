...
var bot = window.bot = (function() {
    return {
        ...
        reinfgo: function() {
            ...
            input.push(window.snake.sc); // NOT NORMALIZED ?? (B/c theoretically infinite; max score: ~200,000
    ...
    return {
        ...
        oefTimer: function() {
            ...
            if (window.playing && bot.isBotEnabled && window.snake !== null) {
                ...
                //   bot.isEvalDone = true;
                // }
            } else if (!bot.isBotTimeout && bot.brain != undefined) {
              play_btn.btnf.click();
            }
